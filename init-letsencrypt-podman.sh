...
# Initialize Let's Encrypt certificates for non-standard ports (PODMAN VERSION)
...
if [ "$DOMAIN" = "your-domain.com" ]; then
    ...
    echo "Usage: ./init-letsencrypt-podman.sh your-domain.com your-email@example.com [staging]"
    exit 1
fi
