...
# Initialize Let's Encrypt certificates for standard ports (80/443)
...
echo "### Initializing Let's Encrypt for $DOMAIN (standard ports 80/443) ###"
echo ""

# Validate domain
if [ "$DOMAIN" = "your-domain.com" ]; then
    echo "Error: Please provide your domain name as the first argument"
    echo "Usage: ./init-letsencrypt-standard-ports.sh your-domain.com your-email@example.com [staging]"
    exit 1
fi
